...
# save plots
setwd("~/Desktop/fantasy/week5/")
ggsave("cc.pdf", plot=cc, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("cs.pdf", plot=cs, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("es.pdf", plot=es, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("jr.pdf", plot=jr, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("jw.pdf", plot=jw, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("kc.pdf", plot=kc, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("kp.pdf", plot=kp, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("mr.pdf", plot=mr, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("sp.pdf", plot=sp, dpi=600, width=160, height=160, units="mm", device="pdf")
ggsave("zb.pdf", plot=zb, dpi=600, width=160, height=160, units="mm", device="pdf")
