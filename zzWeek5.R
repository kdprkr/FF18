...
line.x.labs <- c("Week\n1","Week\n2","Week\n3","Week\n4","Week\n5")
line.x.lims <- c(1,5)
line.x.brks <- c(1,2,3,4,5)
line.y.lims <- c(85, 205)
line.y.brks <- c(100, 125, 150, 175, 200)
lol.y.lims <- c(-1, 903)
lol.y.brks <- c(0, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900)
lol.y.labs <- c("", "50", "", "150", "", "250", "", "350", "", "450", "", "550", "", "650", "", "750", "", "850", "")
lol.y.for <- 870
lol.y.agnst <- 870
...
cc.pts <- c(121.8, 138.2, 130.3, 174.6, 112.2)
cc.bench.pts <- c(55, 60.1, 44, 59.5, 71.2)

cc.opp <- c("KC", "ES", "ZB", "KP", "SP")
cc.opp.pts <- c(140.9, 135.2, 137.4, 146.7, 158.6)
cc.bench.opp.pts <- c(52.9, 59.9, 53.3, 93.4, 51.8)
...
cs.pts <- c(132.4, 130.3, 136.3, 146, 152.2)
cs.bench.pts <- c(62, 48.2, 32.9, 75.7, 39.3)

cs.opp <- c("KP", "MR", "JR", "ES", "JW")
cs.opp.pts <- c(160.8, 162.9, 143.9, 137.6, 131.9)
cs.bench.opp.pts <- c(56.5, 31.4, 33.6, 60, 43.9)
...
es.pts <- c(166.4, 135.2, 134.6, 137.6, 109)
es.bench.pts <- c(37.9, 59.9, 61.9, 60, 45.3)

es.opp <- c("JR", "CC", "JW", "CS", "MR")
es.opp.pts <- c(91.9, 138.2, 118.8, 146, 130.6)
es.bench.opp.pts <- c(41.8, 60.1, 90.4, 75.7, 76.6)
...
jr.pts <- c(91.9, 151.4, 143.9, 166.2, 160.5)
jr.bench.pts <- c(48.8, 62.5, 33.6, 42.1, 56.1)

jr.opp <- c("ES", "JW", "CS", "MR", "KC")
jr.opp.pts <- c(166.4, 167.3, 136.3, 145.9, 100.1)
jr.bench.opp.pts <- c(37.9, 71.2, 32.9, 42.3, 34.8)
...
jw.pts <- c(139.9, 167.3, 118.8, 200.2, 131.9)
jw.bench.pts <- c(70.2, 71.2, 90.4, 93.7, 43.9)

jw.opp <- c("MR", "JR", "ES", "ZB", "CS")
jw.opp.pts <- c(185.3, 151.4, 134.6, 138.5, 152.2)
jw.bench.opp.pts <- c(35.2, 62.5, 61.9, 30.9, 39.3)
...
kc.pts <- c(140.9, 115.6, 129.2, 111.6, 100.1)
kc.bench.pts <- c(52.9, 87.4, 52.7, 100.6, 34.8)

kc.opp <- c("CC", "ZB", "KP", "SP", "JR")
kc.opp.pts <- c(121.8, 158, 165.7, 120.7, 160.5)
kc.bench.opp.pts <- c(55, 110.4, 34.7, 24, 56.1)
...
kp.pts <- c(160.8, 173.9, 165.7, 146.7, 193.6)
kp.bench.pts <- c(56.5, 59.2, 34.7, 93.4, 69.2)

kp.opp <- c("CS", "SP", "KC", "CC", "ZB")
kp.opp.pts <- c(132.4, 151.4, 129.2, 174.6, 149)
kp.bench.opp.pts <- c(62, 52.7, 52.7, 59.5, 37.5)
...
mr.pts <- c(185.3, 162.9, 97.7, 145.9, 130.6)
mr.bench.pts <- c(35.2, 31.4, 51.8, 42.3, 76.6)

mr.opp <- c("JW", "ES", "SP", "JR", "ES")
mr.opp.pts <- c(139.9, 130.3, 121, 166.2, 109)
mr.bench.opp.pts <- c(70.2, 48.2, 86, 42.1, 45.3)
...
sp.pts <- c(163.6, 151.4, 121, 120.7, 158.6)
sp.bench.pts <- c(68.5, 52.7, 86, 24, 51.8)

sp.opp <- c("ZB", "KP", "MR", "KC", "CC")
sp.opp.pts <- c(112.7, 173.9, 97.7, 111.6, 112.2)
sp.bench.opp.pts <- c(72.4, 59.2, 51.8, 100.6, 71.2)
...
zb.pts <- c(112.7, 158, 137.4, 138.5, 149)
zb.bench.pts <- c(72.4, 110.4, 53.3, 30.9, 37.5)

zb.opp <- c("SP", "KC", "CC", "JW", "KP")
zb.opp.pts <- c(163.6, 115.6, 130.3, 200.2, 193.6)
zb.bench.opp.pts <- c(68.5, 87.4, 44, 93.7, 69.2)
...
# save plots
setwd("~/Desktop/fantasy/week5/figs/")
ggsave("cc.tiff", plot=cc, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("cs.tiff", plot=cs, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("es.tiff", plot=es, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("jr.tiff", plot=jr, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("jw.tiff", plot=jw, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("kc.tiff", plot=kc, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("kp.tiff", plot=kp, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("mr.tiff", plot=mr, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("sp.tiff", plot=sp, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
ggsave("zb.tiff", plot=zb, dpi=600, width=160, height=160, units="mm", device="tiff", type="cairo", compression="lzw")
save.image(file="../zzWeek5_WS.Rdata")
